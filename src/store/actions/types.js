...
export const REMOVE_CHANNEL_WAITING_FOR_OPENING = "REMOVE_CHANNEL_WAITING_FOR_OPENING";
export const SET_CHANNEL_AWAITING_CLOSE = "SET_CHANNEL_AWAITING_CLOSE";
export const SET_IS_SETTLING = "SET_IS_SETTLING";
export const SET_IS_UNLOCKING = "SET_IS_UNLOCKING";
export const SET_CHANNEL_UNLOCKED = "SET_CHANNEL_UNLOCKED";
